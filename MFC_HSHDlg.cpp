...
void CMFCHSHDlg::drawCircle3(int centerX, int centerY) {
...
bool CMFCHSHDlg::isinCircle3(int i, int j, int nCenterX, int nCenterY, int nRadius) {
	bool bRet = false;
